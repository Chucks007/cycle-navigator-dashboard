...
from frontend.views import render_overview_tab, render_analysis_tab, render_macro_tab
...
def main():
    ...
    tab_macro, tab_overview, tab_analysis = st.tabs(["🏰 Macro Watchtower", "🏠 Market Overview", "🔍 Detailed Analysis"])
